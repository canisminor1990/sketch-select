    ...
    return (
      <div>
        ...
        <div className="ui-body">
          ...
          <CheckboxGroup options={Options.Layers} onChange={this.onChangeLayers} />
          <div className="ui-title">Text Layers</div>
          <CheckboxGroup options={Options.TextLayers} onChange={this.onChangeTextLayers} />
          ...
          <div className="ui-footer" onClick={this.openWeb}>
            <Icon type="github" />
