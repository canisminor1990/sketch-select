		...
		handlers: {
			onClick: function () {
				function onClick(callback) {
					(0, _handleSelection2['default'])(JSON.parse(callback), context);
				}
...
var _handleSelection = __webpack_require__(4);
...
var Select = (0, _lodash.assign)(_select2['default'].Layers, _select2['default'].TextLayers, _select2['default'].LayerTypes);
...
exports['default'] = function (callback, context) {
	...
	var selectAllAtrboards = callback.SelectAllAtrboards;
	var selectOption = callback.SelectOption;
...
var layerTypes = {
	AllTypes: function () {
		function AllTypes(layer, configLayer) {
			return true;
		}
